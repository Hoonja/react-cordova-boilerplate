...
import {SessionService} from '../security/services/index';
...
export default class APICache {
	...
	static get firstName() {
		if (firstName === null) {
			return (SessionService.isLogin === true ? SessionService.userInfo.actorId.toString() : '');
		} else {
			return firstName;
		}
	}
	...
	static put(url, params, response) {
		...
		return this.db.put({fullUrl, response:data, lastUpdate:Date.now()});
	}
